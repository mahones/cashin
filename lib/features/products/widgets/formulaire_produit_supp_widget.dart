...
class SuppProduit extends StatefulWidget {
  const SuppProduit({super.key});

  @override
  _SuppProduitState createState() => _SuppProduitState();
}

class _SuppProduitState extends State<SuppProduit> {
